...
is upwards of 6 minutes, but C files can be changed and compiled in seconds. But as the Nios II 
...
were implemented on the software running on the Nios II processor to filter out 
