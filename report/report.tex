...
simple system, the connection was successfully implemented by d
ebugging the connection and the messages being sent back and forth.
...
devices was successful. It was discovered that although the NIOS2 processor 
...
using the NIOS2, even if the FPGA itself supported it. Although there is an 
...
the output voltage \(V_{pd}\) further divided by 5/3 using a voltage divider consisting of a 10k
and a 15k resistor. The voltage at this second voltage divider should then be \(V_{out}/5\), 
