...
The Nios II processor does not include floating point hardware by default, but as 
...
prudent to include hardware support for floating point adds and multiplications. 
This was done by adding a module from Intel's IP catalogue for custom floating 
point instructions, this reduces the amount of cycles necessary to carry out a
floating point multiplication from  to   TODO!!!! Check qsys for info, offering 
a speedup factor of .  
