...
\begin{figure}[H]
	\begin{Center}
		\includegraphics[scale = 0.30]{./images/Structural_Diagram.png}
		\caption{Structural Design Diagram showing Hardware and Parameters of Subsystems for Mars Rover}
...
\begin{figure}[H]
	\begin{Center}
		...
		\label{fig:ControlFunctionDesignDiagram}
	\end{Center}
\end{figure}
