...
\subsection{TEMP Each component gets one}
\subsubsection{Requirements}
\subsubsection{Early Design Choices}
...
Intellectual Property (IP) is a complex topic, but it has financial, technological, 
and moral significance when developing and creating products or inventions. In the 
context of our design project, there are sections within IP which are clearly unapplicable. 
These include, design and trademark, seeing as the former was not original; 
it was provided entirely by the university and although the latter could be relevant, 
it wouldn’t provide significance as the product won’t be commercially viable. Patenting 
