...
class EnergyClientConsole():
    ...
    def __init__(self):
        ...
        self.addressport = ("192.168.1.13", 1800) #define server host and port
        try:
            self.arduino = serial.Serial(port = "/dev/cu.usbmodem14201", timeout = 1, baudrate = 38400) #connecting serially to arduino
        except:
